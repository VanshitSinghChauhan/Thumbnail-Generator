...
export default function CTASection() {
    ...
    return (
        <motion.div className="max-w-5xl py-16 mt-40 md:pl-20 md:w-full max-md:mx-4 md:mx-auto flex flex-col md:flex-row max-md:gap-6 items-center justify-between text-left bg-linear-to-b from-orange-900 to-orange-950 rounded-2xl p-6 text-white"
        ...
        >
            <div>
                ...
                >
                    Let your channel soar to new heights with our powerful thumbnail generator.
                </motion.p>
            </div>
