...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            <div className="absolute top-30 -z-10 left-1/4 size-72 bg-yellow-600 blur-[250px]"></div>
            ...
            >
                ...
                <span className="bg-orange-600 move-gradient px-3 rounded-xl text-nowrap">Videos</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Generate stunning thumbnails in seconds with our AI-powered tool.</motion.p>
            ...
            >
                ...
                <button className="flex items-center gap-2 border border-orange-600 hover:bg-orange-950/50 transition rounded-full px-6 h-11">
