...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="What you get" text3="Create stunning thumbnails for your content" />
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature: IFeature, index: number) => (
                    <motion.div key={index} className={`${index === 1 ? 'p-px rounded-[13px] bg-linear-to-br from-orange-600 to-slate-800' : ''}`}
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI understands what makes a thumbnail stand out and uses that knowledge to create designs that are not only visually appealing but also optimized for engagement. Whether you're a content creator, marketer, or business owner, our AI-powered thumbnail generator is your secret weapon for boosting click-through rates and driving more traffic to your content.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Stop wasting time on design and focus on what matters most.</p>
                        <a href="https://prebuiltui.com" className="group flex items-center gap-2 mt-4 text-orange-600 hover:text-orange-700 transition">
