    ...
    return (
        <div className="relative mx-auto w-full max-w-2xl">
            <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
                ...
                {isLoading && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
                        ...
                        <div className="text-center">
                            <p className="text-sm font-medium text-gray-200">Creating your thumbnail...</p>
                            <p className="mt-1 text-xs text-gray-400">This may take 15-30 seconds </p>
                        </div>
                    </div>
                )}
                ...
                {/*Empty State*/}
                {!isLoading && !thumbnail?.image_url &&(
                    <div className="absolute inset-0 m-2 flex flex-col items-center justify-center gap-4 
                    rounded-lg border-2 border-dashed border-white/20 bg-black/25">
