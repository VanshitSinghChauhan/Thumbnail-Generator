...
export interface IThumbnail extends Document{
    ...
    color_scheme?: "vibrant" | "sunset" | "forest" | "neon" | "pink" | "monochrome" | "ocean" | "pastel";
...
const ThumbnailSchema = new mongoose.Schema<IThumbnail>(
    {
        ...
        color_scheme: {type: String, enum: ["vibrant" , "sunset" , "forest" , "neon" , "pink" , "monochrome" , "ocean" , "pastel"]},
